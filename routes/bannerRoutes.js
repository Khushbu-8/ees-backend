...
const { addbanner, getUserByBanner, updateBanner, deleteBanner, getAllBanners } = require('../controllers/bannerController');
...
router.post('/updateBanner',verifyToken,upload.single('banner'),updateBanner)
